      ...
      <div className="bg-zinc-100 dark:bg-zinc-900">
        ...
        <div className="min-h-screen py-[8vh] px-[8vw]">
          ...
          <div className="py-2">
            ...
            us. This Privacy Policy document contains types of information
            ...
            <li className="list-decimal">
              ...
              <div className="pl-4">
                <div className="pb-2">
                  ...
                  collect personal information from you when you voluntarily
                  provide it, for example, when you register on our site, or
                  fill out a form. Personal information may include, but is not
                  limited to:
                  <ul>
                ...
                <div className="pb-2">
                  <div className="-ml-6">(b) Non-personal Information:</div> We
                  may collect non-personal information about you when you
                  interact with our website. Non-personal information may
                  include
                  <ul>
