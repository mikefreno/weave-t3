export default function AngryEmoji(props: { height: number; width: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height={props.height} width={props.width}>
      <rect className="a" x="1" y="1" width="22" height="22" rx="7.656" />
      <path
        className="b"
