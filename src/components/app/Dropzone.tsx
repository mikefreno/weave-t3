...
const Dropzone = ({ onDrop, accept, fileHolder, preSet }: any) => {
  ...
  return (
    <div
      ...
      {...getRootProps()}
    >
      <label htmlFor="upload" className=" flex h-32 w-32 cursor-pointer items-center justify-center">
        <input className="dropzone-input" {...getInputProps()} />
        {(fileHolder !== null || preSet !== null) && !isDragActive ? (
          <div>
            <img src={fileHolder == null ? preSet : fileHolder} className="h-32 w-32 rounded-full" alt="upload" />
          </div>
        ) : isDragActive ? (
          ...
          <>
            ...
            <span id="drop" className="text-md text-zinc-700 dark:text-zinc-400">
              Upload file
              <br />
