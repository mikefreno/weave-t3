...
const AccountPage = (props: {
  ...
  const [realNameImageHolder, setRealNameImageHolder] = useState<string | ArrayBuffer | null>(null);
  ...
  const [pseudonymImageHolder, setPseudonymImageHolder] = useState<string | ArrayBuffer | null>(null);
  ...
  const handleFileInput = (event: React.ChangeEvent<HTMLInputElement>, to_set: string) => {
    if (to_set === "realName") {
  ...
  const updateRealNameImage = async () => {
    ...
    const resizedFile = (await resizeFile(realNameImage as File, ext)) as File;
  ...
  const updatePseudonymImage = async () => {
    ...
    const resizedFile = (await resizeFile(pseudonymImage as File, ext)) as File;
          ...
          <div className="my-4">
            ...
            {realNameImageHolder !== null || pseudonymImageHolder !== null ? (
              <div className="absolute z-10 mx-auto ml-36 rounded-lg bg-zinc-200 px-12 py-2 shadow-lg">
                <img
                  src={
                    realNameImageHolder !== null ? (realNameImageHolder as string) : (pseudonymImageHolder as string)
                  }
                  className="mx-auto h-32 w-32 rounded-full"
                />
                <div className="text-center text-zinc-800">
                  Confirm New Image to {realNameImageHolder !== null ? "Real Name" : "Pseudonym"}?
                </div>
                <div className="-mx-6 flex justify-around py-4">
                  {imageConfirmLoading ? (
                    ...
                    <Button
                      onClick={realNameImageHolder !== null ? updateRealNameImage : updatePseudonymImage}
                      color={"primary"}
                      auto
                    >
                      Confirm
            ...
            <div className="flex flex-col justify-evenly md:flex-row">
              <div className="mx-auto flex flex-col">
                <div className="mx-auto">
                  <img
                    src={`${currentUser.image ? currentUser.image : currentUser.pseudonym_image}?t=${timestamp}`}
                  ...
                  >
                    <span className="mx-auto mt-1 flex">
                      <PencilIcon height={14} width={14} color={isDarkTheme ? "#27272a" : "#f4f4f5"} />
                    </span>
                  </label>
                  <input
                    ref={fileInputRef}
                  ...
                  />
                  <div className="flex justify-center pt-2 text-sm italic">Real Name image</div>
                </div>
              ...
              <div className="mx-auto flex flex-col pt-8 md:pt-0">
                <div className="mx-auto">
                  <img
                    src={`${
                      currentUser.pseudonym_image ? currentUser.pseudonym_image : currentUser.image
                    }?t=${timestamp}`}
                    className={`h-32 w-32 rounded-full ${isDarkTheme ? "bg-zinc-800" : "bg-zinc-50"}`}
                  />
                  <label
                  ...
                  <input
                    ...
                    accept="image/png, image/jpeg"
                  />
                  <div className="flex justify-center pt-2 text-sm italic">Pseudonym image</div>
                </div>
                <div className="mx-4 my-4 flex flex-col">
                    ...
                    <div className="flex flex-row">
                      ...
                      <div className="ml-16">
                        ...
                        {currentUser.pseudonym ? (
                          <div className="w-24 break-words">{currentUser.pseudonym}</div>
                        ) : (
                          <div className="w-24 break-words italic">None Set</div>
                        )}
                      </div>
                    </div>
                  </form>
          ...
          <div className="my-4 w-full">
            <div className="flex justify-center">
              <div className="w-full text-center md:w-3/4 lg:w-1/2 ">
                <div>
                  Depending on the community they may require you to use your real name. Others allow you to use a
                  pseudonym.
                </div>
    ...
    if (settingsSelection === "Privacy") {
      return (
        <div>
          ...
          >
            <Radio value="ask">Ask for every community - you can change in community settings tab</Radio>
            <Radio value="never">
              Never allow real name <br />
              (this will block you from joining communities where real names are enforced)
            </Radio>
          ...
          >
            <Tooltip content="No pseudonym is set" placement="top">
              <Radio isDisabled={currentUser.pseudonym ? false : true} value="pseudonym">
                Prefer Pseudonym
              </Radio>
            </Tooltip>
  ...
  return (
    <div className="h-screen w-full overflow-y-scroll bg-zinc-100 dark:bg-zinc-700 md:flex">
        ...
        <div className="fixed z-[10000] flex w-full flex-row px-4 py-4 text-xl tracking-wide underline underline-offset-4 md:w-fit">
          <div className="flex">
            <button className="z-50 flex md:cursor-default" onClick={toggleSettingsMenu}>
              ...
              >
                <ChevronDown height={30} width={30} stroke={isDarkTheme ? "#fafafa" : "#18181b"} strokeWidth={1} />
              </div>
            </button>
          </div>
        </div>
          ...
          >
            <li className="hvr-move-right">
              <button
                ...
                className={`${settingsSelection === "User" ? "underline" : ""}  underline-offset-4`}
              >
                User
              </button>
            </li>
            <li className="hvr-move-right">
              <button
                ...
                className={`${settingsSelection === "App" ? "underline" : ""}  underline-offset-4`}
              >
                App
              </button>
            </li>
            <li className="hvr-move-right">
              <button
                ...
                className={`${settingsSelection === "Privacy" ? "underline" : ""}  underline-offset-4`}
              >
                Privacy
              </button>
            </li>
            <li className="hvr-move-right">
              <button
                ...
                className={`${settingsSelection === "Notification" ? "underline" : ""}  underline-offset-4`}
              >
                Notification
              </button>
            </li>
            <li className="hvr-move-right">
              <button
                ...
                className={`${settingsSelection === "Accessibility" ? "underline" : ""}  underline-offset-4`}
              >
                Accessibility
              </button>
            </li>
            <li className="hvr-move-right">
              <button
                ...
                className={`${settingsSelection === "Community" ? "underline" : ""}  underline-offset-4`}
              >
                Community
              </button>
            </li>
            <li className="hvr-move-right">
              <button
                ...
                className={`${settingsSelection === "Other" ? "underline" : ""}  underline-offset-4`}
              >
                Other
              </button>
            </li>
      ...
      <div id="settingsMain" className="flex px-6 pt-20 md:pt-24">
        <div className="">
          <div className="pb-4 text-3xl underline underline-offset-2">{settingsSelection} Settings</div>
