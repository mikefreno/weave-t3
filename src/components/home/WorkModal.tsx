    ...
    <div className={`z-50 max-w-[40vw] rounded-2xl p-1 backdrop-blur ${isDarkTheme ? "darkBorder" : "lightBorder"}`}>
      ...
      >
        <span className="flex justify-center">
          <BriefcaseIcon height={144} width={144} stroke={isDarkTheme ? "#f4f4f5" : "#27272a"} strokeWidth={0.5} />
        </span>
        <div className="text-[#171717] dark:text-[#E2E2E2]">
          <h3 className="text-md text-center">Easy Coordination</h3>
          <p className="text-center text-sm">
            Be it in network hierarchy, current availability, real-name enforcement, etc.
          </p>
        </div>
      </div>
    </div>
